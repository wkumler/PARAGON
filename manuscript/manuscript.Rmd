...
Other compounds, including betaines (here restricted to quaternary amines with a carboxylic acid group) and choline derivatives showed very little labeling at all, with only homarine (15.0% labeled) `r wc("double check these numbers after rerun")`` and O-acetylcarnitine (9.9% labeled) exceeding 5% labeling after 24 hours.
