...
We were unfortunately unable to present the data collected from the 175 meter labeled nitrate incubations here due to missed timepoints and our inability to confidently connect data to the correct timepoint for those samples but the raw numbers are provided in the supplement (Supplemental Figure XX).
